...
def conclusion():
    ...
    st.write(
        "Thank you for viewing our demo. We hope this work inspires further research and development with the goal of "
        "building a safer and more productive social media landscape."
    )
    st.markdown(
        """
